...
@section('conteudo')
    ...
    <p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do Chronos respeitar a sua
            privacidade em relação a qualquer informação sua que possamos coletar no site <a
                href="https://chornos.app">Chronos</a>, e outros sites que possuímos e operamos.</span></p>
    ...
    <p><span style="color: rgb(68, 68, 68);">O nosso site pode ter links para sites externos que não são operados por nós.
            ...
            rel="noopener noreferrer" target="_blank" style="background-color: transparent; color: rgb(68, 68, 68);">políticas
    ...
    <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos e da informação que
            o Chronos oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
    <ul>
        ...
        <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares)
                do Chronos, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer
    ...
    <p><span style="color: rgb(68, 68, 68);">Esta política é efetiva a partir de&nbsp;12 July 2023 22:22</span></p>
@endsection

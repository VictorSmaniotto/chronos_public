...
@section('conteudo')
    <h2 class="mt-3"><span style="color: rgb(68, 68, 68);">1. Termos</span></h2>
    <p><span style="color: rgb(68, 68, 68);">Ao acessar ao site <a href="https://chornos.app">Chronos</a>, concorda em cumprir
    ...
    <p><span style="color: rgb(68, 68, 68);">É concedida permissão para baixar temporariamente uma cópia dos materiais
            (informações ou software) no site Chronos , apenas para visualização transitória pessoal e não comercial. Esta é
    ...
    <ol>
        ...
        <li><span style="color: rgb(68, 68, 68);">tentar descompilar ou fazer engenharia reversa de qualquer software contido
                no site Chronos;&nbsp;</span></li>
    ...
    <p><span style="color: rgb(68, 68, 68);">Esta licença será automaticamente rescindida se você violar alguma dessas
            restrições e poderá ser rescindida por Chronos a qualquer momento. Ao encerrar a visualização desses materiais
    ...
    <ol>
        <li><span style="color: rgb(68, 68, 68);">Os materiais no site da Chronos são fornecidos 'como estão'. Chronos não
        ...
        <li><span style="color: rgb(68, 68, 68);">Além disso, o Chronos não garante ou faz qualquer representação relativa à
    ...
    <p><span style="color: rgb(68, 68, 68);">Em nenhum caso o Chronos ou seus fornecedores serão responsáveis ​​por
            quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos
            negócios) decorrentes do uso ou da incapacidade de usar os materiais em Chronos, mesmo que Chronos ou um
            representante autorizado da Chronos tenha sido notificado oralmente ou por escrito da possibilidade de tais
            danos. Como algumas jurisdições não permitem limitações em garantias implícitas, ou limitações de
            responsabilidade por danos conseqüentes ou incidentais, essas limitações podem não se aplicar a você.</span></p>
    <h2><span style="color: rgb(68, 68, 68);">5. Precisão dos materiais</span></h2>
    <p><span style="color: rgb(68, 68, 68);">Os materiais exibidos no site da Chronos podem incluir erros técnicos,
            tipográficos ou fotográficos. Chronos não garante que qualquer material em seu site seja preciso, completo ou
            atual. Chronos pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No
            entanto, Chronos não se compromete a atualizar os materiais.</span></p>
    <h2><span style="color: rgb(68, 68, 68);">6. Links</span></h2>
    <p><span style="color: rgb(68, 68, 68);">O Chronos não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por Chronos
    ...
    <p><span style="color: rgb(68, 68, 68);">O Chronos pode revisar estes termos de serviço do site a qualquer momento, sem
    ...
    <p><span style="color: rgb(68, 68, 68);">Estes termos e condições são regidos e interpretados de acordo com as leis do
            Chronos e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele estado ou
            localidade.</span></p>
@endsection
